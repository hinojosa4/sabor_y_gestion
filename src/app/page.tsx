...
export default function Home() {
  ...
  return (
    <main style={{background:'#f8f7f4',minHeight:'100vh',fontFamily:"'DM Sans',sans-serif",overflow:'hidden',position:'relative'}}>
      <style>{`
      ...
      {/* Blobs decorativos */}
      <div style={{position:'absolute',width:420,height:420,background:'rgba(232,93,38,0.08)',top:-120,right:-80,borderRadius:'50%',pointerEvents:'none'}}/>
      <div style={{position:'absolute',width:280,height:280,background:'rgba(232,93,38,0.06)',bottom:60,left:-60,borderRadius:'50%',pointerEvents:'none'}}/>
      <div style={{position:'absolute',width:160,height:160,background:'rgba(232,93,38,0.12)',top:200,left:30,borderRadius:'50%',pointerEvents:'none'}}/>

      {/* Navbar */}
      <nav style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'1.2rem 2rem',background:'#fff',borderBottom:'1px solid #e0e0e0',position:'relative',zIndex:10}}>
        <div style={{fontFamily:"'Playfair Display',serif",fontSize:'1.35rem',fontWeight:700,color:'#1a1a1a',letterSpacing:'-0.3px'}}>
      ...
      {/* Hero */}
      <section style={{display:'flex',flexDirection:'column',alignItems:'center',textAlign:'center',padding:'5rem 2rem 3rem',position:'relative',zIndex:2}}>
        ...
        <h1 style={{fontFamily:"'Playfair Display',serif",fontSize:'3.4rem',fontWeight:900,color:'#1a1a1a',lineHeight:1.08,marginBottom:'1.2rem',maxWidth:600}}>
          Explora el menú,<br/>reserva tu <span style={{color:'#e85d26'}}>mesa</span>
        </h1>

        <p style={{fontSize:'1.05rem',color:'#555',maxWidth:440,lineHeight:1.65,marginBottom:'2.5rem'}}>
      ...
      {/* Features */}
      <section style={{padding:'2.5rem 2rem 3.5rem',position:'relative',zIndex:2}}>
