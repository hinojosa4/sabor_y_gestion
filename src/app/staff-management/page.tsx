    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center font-semibold text-gray-700">Cargando...</div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-gray-50"
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-black leading-none font-semibold">Gestión de Personal</h1>
                                    <p className="text-xs md:text-sm text-gray-500">Administra tu equipo de trabajo</p>
                                </div>
                            </div>
                        </div>
                        <Button onClick={() => {
            ...
            <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-3 md:py-5">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-6 md:mb-8">
                    ...
                    <div className="rounded-xl border border-gray-200 bg-white shadow">
                        <div className="p-6">
                            <p className="text-xs md:text-sm text-gray-500">Personal Activo</p>
                            <p className="mt-10 text-2xl md:text-3xl font-light text-green-600">{stats.active}</p>
                        </div>
                    </div>
                    <div className="rounded-xl border border-gray-200 bg-white shadow">
                        <div className="p-6">
                            <p className="text-xs md:text-sm text-gray-500">En Vacaciones</p>
                            <p className="mt-10 text-2xl md:text-3xl font-light text-blue-600">{stats.onVacation}</p>
                        </div>
                    </div>
                    <div className="rounded-xl border border-gray-200 bg-white shadow">
                        <div className="p-6">
                            <p className="text-xs md:text-sm text-gray-500">Nómina Mensual</p>
                            <p className="mt-10 text-xl md:text-2xl text-black">${stats.monthlyPayroll.toLocaleString()}</p>
                        </div>
                    </div>
                </div>
