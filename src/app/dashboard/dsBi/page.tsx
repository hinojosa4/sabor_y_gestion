            ...
            <main style={mainStyle}>
                {loading || metricsLoading ? (
                    ...
                    <>
                        ...
                        {activeTab === 'meseros' && (
                            <div>
                                <h2 style={{ fontSize: "1.25rem", fontWeight: "bold", marginBottom: "1.5rem" }}>🥇 Top Meseros</h2>
                                <div style={cardStyle}>
                                    {metricsLoading ? (
                                        <p>Cargando...</p>
                                    ) : (
                                        <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                                            {metrics?.topWaiters?.map((waiter, idx) => (
                                                <li key={waiter.id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0.75rem 0", borderBottom: "1px solid var(--border)" }}>
                                                    <span>#{idx + 1} {waiter.name}</span>
                                                    <span style={{ fontWeight: "bold" }}>{formatCurrency(waiter.total)}</span>
                                                </li>
                                            ))}
