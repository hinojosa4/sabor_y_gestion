...
export default function DashboardPage() {
  ...
  const quickActions = [
    ...
    { icon: "VIP", title: "Segmentación de Clientes", desc: "Configura categorías, segmentación y descuentos para clientes", route: "/dashboard/fidelizacion", color: "#c2410c", bg: "#fff8f5", border: "#fed7aa", stats: "Categorías y descuentos" },
